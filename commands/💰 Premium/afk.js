...
const es = require(`${process.cwd()}/botconfig/embed.json`);
  ...
  run: async (client, message, args, user, text, prefix, player) => {
    ...
    return message.reply({
      embeds: [new MessageEmbed()
        ...
        .setTitle(eval(client.la["en"]["cmds"]["settings"]["afk"]["variable1"]))
        .setDescription(eval(client.la["en"]["cmds"]["settings"]["afk"]["variable2"]))
      ]
    });
  }
}
